    ...
    <>
      <div className="about">
        <div className="about-container">
          ...
          <div className="about-content">
            ...
            <div className="about-text">
              <p>
                My name is Surendra Rayamajhi. I'm a <span>curious</span> and{" "}
                <span>passionate</span> fullstack software engineer with a B.E.
                in Information Technology and a IT Engineer Academy grad.
                My passions generally consist of research in new tool and advance technology, photography, and music.
                I don&apos;t own my Goal yet, but I hope to achieve one some day.
                <br></br>
                <br></br>
              </p>
              <p>
                ...
                Full Stack Developer and MERN stack to bring concepts to life in a tangible way.
              </p>
            </div>
          </div>
        </div>
        <div className="pfp-container">
          ...
          <img src={Image} alt=""/>
            <div className="pfp-layer">
              
            </div>
          </div>
          <div className="profile-links">
            <a
              href="https://np.linkedin.com/in/surendra-r-417a28166/"
              target="_blank"
            ...
            <a
              href="https://github.com/Surendrarayamajhi"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg
